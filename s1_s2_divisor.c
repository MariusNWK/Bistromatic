...
char *val_new_b_p_div(int i1_result, int i2_result, char *b_p, char *result)
{
    int i = 0;
    char *new_b_p;
...
char *s1_s2_divisor(char *b_p, char c)
{
    int i = 0;
    char *s1;
    char *s2;
    ...
    if (b_p[i] == '/') {
        ...
        new_b_p = val_new_b_p_div(i1_result, i2_result, b_p, result);
        return (new_b_p);
    }
    return (b_p);
}
